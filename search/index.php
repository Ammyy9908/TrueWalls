...
<div class="hero is-large is-black is-fixed-top" style="background-image: url(https://source.unsplash.com/1600x900/?<?php echo $_GET['key'];?>);background-attachment:fixed;background-size:cover;">
<div class="hero-body">
...
<?php
        ...
        if ($rowcount > 0) {
          ...
          <figure class="image is-square">
            ...
            <button class="button is-info is-rounded"><i class="material-icons">file_download</i></button>
          </div>
        </div>
